...
public class DownStreamMain2 {
    ...
    public static void main(String[] args) {
        List<Student> students = List.of(
                new Student("Jung", 1, 85),
                new Student("Park", 2, 75),
                new Student("Lee", 1, 95),
                new Student("Han", 2, 65),
                new Student("Yoon", 3, 75),
                new Student("Hong", 3, 65)
                                        );
        ...
        Map<Integer, Optional<Student>> collect3 = students.stream()
                                                           .collect(Collectors.groupingBy(
                                                                   Student::getGrade,
                                                                   Collectors.maxBy((s1, s2) -> Integer.compare(
                                                                           s1.getScore(),
                                                                           s2.getScore()
                                                                                                               ))
                                                                                         ));
        ...
        // 학년별 그룹 -> 그룹별 가장 점수가 높은 학생 -> 그룹별 최고점 학생 -> 그룹별 이름
