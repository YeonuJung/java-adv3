...
public class PrimitiveStreamMain {
    ...
    public static void main(String[] args) {
        ...
        IntStream range1 = IntStream.range(1, 6); // [1, 2, 3, 4, 5] 마지막 포함 X
        IntStream range2 = IntStream.rangeClosed(1, 5); // [1, 2, 3, 4, 5] 마지막 포함
        ...
        // average(): 평균값 계산(값이 OptionalDouble로 나옴)
        ...
        DoubleStream doubleStream = IntStream.range(1, 5)
                                             .asDoubleStream();
        // IntStream -> Stream<Integer>
        Stream<Integer> boxedStream = IntStream.range(1, 5)
                                               .boxed();

        // 3. 기본형 특화 매핑(매핑 하면서 당연히 타입도 바뀜)
        // int -> long 변환 매핑
