...
public class OptionalRetrievalMain {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("optEmpty.get() = " + optEmpty.get()); 예외 발생 -> 주석처리
        ...
        Optional<Object> empty4 = optEmpty.or(() -> Optional.of("Fallback"));
        System.out.println("value4 = " + value4); // 값이 이미 존재하니 원본 그대로
        System.out.println("empty4 = " + empty4); // 값이 없으니 대체 옵셔널 반환
    }
}
